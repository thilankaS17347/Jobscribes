    ...
    return (
        ...
        S" /></figure>
                                ...
                                <div className="card-block-info">
                                    ...
                                    <p className="font-sm color-text-paragraph mt-20"></p>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 grid-bd-16 hover-up">
                                <div className="card-grid-2-image"><span className="lbl-hot"><span>Full time</span></span>
                                    <div className="image-box">
                                        <figure><img src="assets/imgs/page/homepage2/img2.png" alt="JOBSCRIBES
        S" /></figure>
                                    </div>
                                </div>
                                <div className="card-block-info">
                                    ...
                                    <div className="mt-5"><span className="card-location mr-15">colombo</span><span className="card-time">6 mins ago</span></div>
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            <div className="col-xl-7 col-md-7 mb-2">
                                            ...
                                            <div className="col-xl-5 col-md-5 text-lg-end"><span className="card-text-price">Rs.65,000</span><span className="text-muted"></span></div>
                                        </div>
                                    </div>
                                    <p className="font-sm color-text-paragraph mt-20"></p>
                                </div>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 grid-bd-16 hover-up">
                                <div className="card-grid-2-image"><span className="lbl-hot"><span>Full time</span></span>
                                    <div className="image-box">
                                        <figure><img src="assets/imgs/page/homepage2/img3.png" alt="JOBSCRIBES
        S" /></figure>
                                    </div>
                                </div>
                                <div className="card-block-info">
                                    ...
                                    <div className="mt-5"><span className="card-location mr-15">colombo</span><span className="card-time">9 mins ago</span></div>
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            <div className="col-xl-7 col-md-7 mb-2">
                                            ...
                                            <div className="col-xl-5 col-md-5 text-lg-end"><span className="card-text-price">Rs.150,000</span><span className="text-muted"></span></div>
                                        </div>
                                    </div>
                                    <p className="font-sm color-text-paragraph mt-20"></p>
                                </div>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 grid-bd-16 hover-up">
                                <div className="card-grid-2-image"><span className="lbl-hot"><span>Full time</span></span>
                                    <div className="image-box">
                                        <figure><img src="assets/imgs/page/homepage2/img4.png" alt="JOBSCRIBES
        S" /></figure>
                                    </div>
                                </div>
                                <div className="card-block-info">
                                    ...
                                    <div className="mt-5"><span className="card-location mr-15">colombo</span><span className="card-time">13 mins ago</span></div>
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            <div className="col-xl-7 col-md-7 mb-2">
                                            ...
                                            <div className="col-xl-5 col-md-5 text-lg-end"><span className="card-text-price">Rs.75,000</span><span className="text-muted"></span></div>
                                        </div>
                                    </div>
                                    <p className="font-sm color-text-paragraph mt-20"></p>
                                </div>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 grid-bd-16 hover-up">
                                <div className="card-grid-2-image"><span className="lbl-hot"><span>Full time</span></span>
                                    <div className="image-box">
                                        <figure><img src="assets/imgs/page/homepage2/img5.png" alt="JOBSCRIBES
        S" /></figure>
                                    </div>
                                </div>
                                <div className="card-block-info">
                                    ...
                                    <div className="mt-5"><span className="card-location mr-15">colombo</span><span className="card-time">16 mins ago</span></div>
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            <div className="col-xl-7 col-md-7 mb-2">
                                            ...
                                            <div className="col-xl-5 col-md-5 text-lg-end"><span className="card-text-price">Rs.100,000</span><span className="text-muted"></span></div>
                                        </div>
                                    </div>
                                    <p className="font-sm color-text-paragraph mt-20"></p>
                                </div>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 grid-bd-16 hover-up">
                                <div className="card-grid-2-image"><span className="lbl-hot"><span>Full time</span></span>
                                    <div className="image-box">
                                        <figure><img src="assets/imgs/page/homepage2/img6.png" alt="JOBSCRIBES
        S" /></figure>
                                    </div>
                                </div>
                                <div className="card-block-info" >
                                    ...
                                    <div className="mt-5"><span className="card-location mr-15">colombo</span><span className="card-time">30 mins ago</span></div>
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            <div className="col-xl-7 col-md-7 mb-2">
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 grid-bd-16 hover-up">
                                <div className="card-grid-2-image"><span className="lbl-hot"><span>Full time</span></span>
                                    <div className="image-box">
                                        <figure><img src="assets/imgs/page/homepage2/img2.png" alt="JOBSCRIBES" /></figure>
                                    </div>
                                </div>
                                <div className="card-block-info">
                                    <h5>
                                    ...
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            ...
                                            <div className="col-xl-5 col-md-5 text-lg-end"><span className="card-text-price">Rs.80,000</span><span className="text-muted"></span></div>
                                        </div>
                                    </div>
                                ...
                                <div className="card-block-info">
                                    ...
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            ...
                                            <div className="col-xl-5 col-md-5 text-lg-end"><span className="card-text-price">Rs.90,000</span><span className="text-muted"></span></div>
                                        </div>
                                    </div>
                                    <p className="font-sm color-text-paragraph mt-20">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur</p>
                                </div>
                                ...
                                <div className="card-block-info">
                                    ...
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            ...
                                            <div className="col-xl-5 col-md-5 text-lg-end"><span className="card-text-price">Rs.85,000</span><span className="text-muted"></span></div>
                                        </div>
                                    </div>
                                    <p className="font-sm color-text-paragraph mt-20">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur</p>
                                </div>
                                ...
                                <div className="card-block-info">
                                    ...
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            ...
                                            <div className="col-xl-5 col-md-5 text-lg-end"><span className="card-text-price">Rs.60,000</span><span className="text-muted"></span></div>
                                        </div>
                                    </div>
                                    <p className="font-sm color-text-paragraph mt-20">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur</p>
                                </div>
                                ...
                                <div className="card-block-info">
                                    ...
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            ...
                                            <div className="col-xl-5 col-md-5 text-lg-end"><span className="card-text-price">Rs.50,000</span><span className="text-muted"></span></div>
                                        </div>
                                    </div>
                                    <p className="font-sm color-text-paragraph mt-20">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur</p>
                                </div>
